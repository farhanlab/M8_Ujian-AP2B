...
def request_book_status_from_api(isbn, current_thread_name):
    ...
    target_url = f"BASE_API_URL?name={isbn}"
    log_client_activity_safe(current_thread_name, f"Mengirim permintaan ke {target_url}")
    ...
    try:
        ...
        log_client_activity_safe(current_thread_name, "Permintaan timeout.")
    except requests.exceptions.RequestException as e:
        log_client_activity_safe(current_thread_name, f"Error permintaan umum: {e}")
    except Exception as e:
        log_client_activity_safe(current_thread_name, f"Kesalahan tak terduga: {e}")
    
        log_client_activity_safe(current_thread_name, f"Tugas untuk {isbn} ini selesai.")
    # =================================================
